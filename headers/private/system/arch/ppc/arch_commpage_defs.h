...
#define COMMPAGE_ENTRY_PPC_THREAD_EXIT	(COMMPAGE_ENTRY_FIRST_ARCH_SPECIFIC + 2)
#define COMMPAGE_ENTRY_PPC_SIGNAL_HANDLER	(COMMPAGE_ENTRY_FIRST_ARCH_SPECIFIC + 3)
